...
export const CONTACT_HEIGHT_CUES=defineAcademyCueSet({ownerId:'strike-depth',cues:[
  {...base,cueId:'academy.contact-height.s0.entry',surfaceId:'contact-height-s0',job:'orient',trigger:'surface-entry',text:'Move the arc vertically. Contact height changes millimeter for millimeter; the modeled tangent does not rotate.',beats:[{targetId:'contact-height-window',atMs:0,emphasis:'outline'}]},
  {...base,cueId:'academy.contact-height.s1.entry',surfaceId:'contact-height-s1',job:'cue',trigger:'surface-entry',text:'Bottom height plus arc lift gives the modeled height at the ball.',beats:[{targetId:'contact-height-ledger',atMs:0,emphasis:'connector'}]},
  {...base,cueId:'academy.contact-height.s1.center',surfaceId:'contact-height-s1',job:'consequence',trigger:'proof-first',text:'You crossed the ball center while the modeled Attack Angle stayed exactly unchanged.',beats:[{targetId:'contact-height-point',atMs:0,emphasis:'static-label'}]},
  {...base,cueId:'academy.contact-height.s2.entry',surfaceId:'contact-height-s2',job:'cue',trigger:'surface-entry',text:'Vertical height moves contact directly. Low Point distance changes the lift available before the ball. Do not count Attack twice.',beats:[{targetId:'contact-height-roles',atMs:0,emphasis:'connector'}]},
  ...
  {...base,cueId:'academy.contact-height.s4.live',surfaceId:'contact-height-s4',job:'cue',trigger:'surface-entry',text:'Change only vertical arc height. Capture one low point-path state and one above-center state with the same Attack.',beats:[{targetId:'contact-height-live',atMs:0,emphasis:'outline'}]},
  {...base,cueId:'academy.contact-height.s5.pass',surfaceId:'contact-height-s5',job:'consequence',trigger:'mastery-first',text:'You moved modeled contact without rotating the tangent. The core strike-and-contact journey is complete.',beats:[{targetId:'contact-height-result',atMs:0,emphasis:'static-label'}]},
]});
