...
const SHEETS = Object.freeze({
  ...
  noFloor: {
    eyebrow:'No engine limit',
    title:'There is no floor',
...
export function mountNativeBackspinLesson(options = {}) {
  ...
  function renderLab() {
    ...
    if (solved.displayLimit === 'ceiling') {
      ...
      limit.hidden = false;
      limit.dataset.sheet = 'noFloor';
      limit.textContent = 'No floor';
      limit.setAttribute('aria-label', 'No floor: spin keeps falling toward zero. Open explanation.');
    } else {
      limit.hidden = true;
  ...
  function renderInfluence() {
    ...
    const limitCopy = solved.displayLimit === 'ceiling'
      ...
      : solved.displayLimit === 'no-floor'
        ? 'Underlying model sensitivity \u00B7 no lower bound, display tracks the model'
        : usesRaw
