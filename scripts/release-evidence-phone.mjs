...
export const CANONICAL_SMOKE_REQUIREMENTS = Object.freeze([
  ...
  'Product-map links open Outcome, Studio and Guide in separate fresh attempts, with the bottom navigation and Back path usable.',
  'Home, Outcome, Studio and Guide each render and respond in portrait without horizontal overflow, clipped primary actions or unusable controls.',
  'Rotate through every orientation the app permits; content reflows or the native lock is respected without a stuck/blank surface.',
