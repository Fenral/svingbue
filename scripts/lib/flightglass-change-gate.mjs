...
const LEVEL_C_PATTERNS = [
  ...
  [/^scripts\/(?:configure-native-iap|monetization-contract\.test|native-release-contract\.test|phase4-iap-contract\.test|phase4-paywall-browser\.test|release-evidence-onboarding(?:\.test)?|store-release-contract\.test|store-screenshots)\.mjs$/, 'billing and native release controls'],
